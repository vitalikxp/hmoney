...
13. **Двухуровневая модель конвертов** — 2 системных (ХаниМани, Резервы) + до 20 пользовательских (fund/goal суммарно). Лимит 20 обеспечивает разумный UX, проверяется в store перед созданием
